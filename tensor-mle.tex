...
%-----------------------------------------------------------------------------
As suggested in step~\ref{it:convexity} of the plan from the previous section, we now compute the gradient of $f_{\vec X}$ and bound it using basic matrix concentration results.
...
\MW{Please check that I did not introduce problems. Can we take $\eps<1$ and write $C\geq16$ some absolute constant?}
