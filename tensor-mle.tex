...
There is a constant $c>0$ such that the following holds. For input $\{X_{i}\}$ such that $d_{a}\|\rho_{X}^{(a)}\|_{op} \leq c$; and perturbation $\delta := \sum_{a} (\delta_{a})_{a}$ with $\|\delta\|_{op} = \sum_{a} \|\delta_{a}\|_{op} \leq c$ giving $\{X'_{i} := e^{\delta} X_{i} \}$, there is a universal constant $C$:
...
So assuming our initial condition $d_{a} \|\rho_{X}^{(a)}\|_{op} \leq O(1)$, this is some fixed constant. 
...
There is a constant $c>0$ such that the following holds. For input $\{X_{i}\}$ such that $\|d_{a} \rho_{X}^{(a)}\|_{op}, \|d_{b} \rho_{X}^{(b)}\|_{op} \leq c$; and perturbation $\delta := \sum_{a} (\delta_{a})_{a}$ with $\|\delta\|_{op} = \sum_{a} \|\delta_{a}\|_{op} \leq c$ giving $\{X'_{i} := e^{\delta} X_{i} \}$, there is a universal constant $C$:
...
There is a constant $c>0$ such that the following holds. If $f_{X}$ is $\alpha$-strongly convex at $I$ and $\sum_{a} \|\delta_{a}\|_{op} \leq c$, then there is a universal constant $C$: $f$ is $\geq (\alpha - k C \|\delta\|_{op})$-strongly convex at $e^{\delta} := \otimes_{a} e^{\delta_{a}}$. 
\end{lemma}
\begin{proof}
