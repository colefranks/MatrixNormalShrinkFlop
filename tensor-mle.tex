...
We now use \cref{thm:operator-cheeger} as well as some slightly more refined concentration inequalities to prove \cref{thm:matrix-normal}. The additional concentration is required to obtain the tighter bounds on the lower-dimensional factor $\Theta_1$. 
\CF{cite the better concentration bounds and use them to prove the theorem!}

\CF{OLD PROOF WHICH NEEDS TO BE UPDATED ACCORDINGLY: 
...
\CF{STATE THIS IN TERMS OF $(\eps, \delta)$-quantum expansion to be consistent with sec 4!!!!}
