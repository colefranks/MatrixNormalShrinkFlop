...
For which we need $TD \gtrsim \max_{a} d_{a}^{\frac{5}{2}} \log d_{a}$.
...
So this means in the first case, we need $TD \gtrsim \max_{a} d_{a}^{2} \log D$ and the second case we need $TD \gtrsim \max_{a} d_{a}^{3} \log D$. 
