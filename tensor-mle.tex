...
\MW{What does the $\Omega$ depend on? Universal constant?}\CF{yes, isn't that the usual assumption?}\MW{Not sure, but if we use this consistently let's add to the notations!}
\MW{Why is the RHS not $\sqrt{d_1} + \sqrt{d_2}$?} \CF{probably a mistake!}
