...
%=============================================================================
\begin{frontmatter}
\title{Sample complexity for matrix and tensor normal models via geodesic convexity}
...
by the approximate triangle inequality for the relative spectral error \CF{cite}. Now $D_{op}(A|| I_{d_1}) = |1 - \det\left(\Phi_\samp^*(I_{d_2})/ nd_1\right)^{\frac{1}{2n}}| = O(\eps_0)$ by the $\eps_0$-balancedness of $\Phi_\samp^*(I_{d_2})/ nd_1$ and \cref{it:norm}. 
