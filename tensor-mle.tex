...
We first explain how \cref{thm:Pisier-expansion}, along with the following estimate of the operator norm of a standard Gaussian $n \times m$ random matrix~$A$ (see \MW{add ref} in \cite{P86}),
...
\begin{theorem}[\MW{add ref} in \cite{P86}]\label{thm:banach conc}
...
Another equivalent definition of sub-Gaussianity is \MW{add ref for equivalence}
...
\end{align*}
Thus, we have proved that \MW{(we needed this bound for the $p$-th powers)}
...
\MW{Remind me how we use the 2nd half of the preceding sentence?}
