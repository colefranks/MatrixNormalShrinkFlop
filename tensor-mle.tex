...
\begin{align*}
  \widehat{\Theta}_1, \dots, \widehat{\Theta}_k := \underset{\det \Theta_1 = \ldots = \det \Theta_k}{ \arg\max} \ell_x(\Theta_1, \dots, \Theta_k).
\end{align*}
...
\item Set $\Upsilon = \frac{1}{n d_1} \sum_{i = 1}^n \samp_i^T \overline{\Theta}_1 \samp_i$.
