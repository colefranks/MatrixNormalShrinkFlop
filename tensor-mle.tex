...
There is a constant $c>0$ such that if $f_x$ is $\lambda$-strongly convex at~$I_D$,
$\norm{\nabla_a f_x(I_D)}_{\op} \leq \frac c{\sqrt{d_a}}$ for every $a\in[k]$ \MW{something needed for the 0 component?},
