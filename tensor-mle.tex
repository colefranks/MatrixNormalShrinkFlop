...
\begin{proof}[Proof.] \CF{An attempt where I understand the basic premise, but the numbers aren't coming out right} We wish to show that, restricted to the subspace $\oplus_a $ 
