...
\item In the tensor normal model, for some $n_0 = O_k( \max\{d_i^3\}/ \prod_i d_i)$, if $n \geq n_0$ then the MLE for the precision matrix $\Theta$ has error $O_k( \frac{d_{\max}}{\sqrt{n}} )$ in $D_F$. We also give a tight bound for the error of the largest kronecker factor $\Theta_i$.
