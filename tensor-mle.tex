...
For $\Theta_1, \Theta_2$ positive-definite $d\times d$ matrices, define
...
\subsection{Notation}
\CF{temporary, or perhaps move to section.}
\begin{itemize}
...
\CF{perhaps move some of this before the results and some to next section}
...
Let $f\colon \PD\to \R$ be geodesically convex everywhere, and $\lambda$-strongly geodesically convex in a geodesic ball $B_\kappa$ of radius~$\kappa>0$ about~$I$.
...
\RMO{are we going to assume that $d_1 \geq d_2 \geq \cdots \geq d_k$?}
