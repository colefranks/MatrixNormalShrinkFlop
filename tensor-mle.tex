...
\end{equation}
implies \cref{thm:hess-pisier}. \AR{Removed $\Theta$} \MW{I think we also need the other side to wrap up the proof.}
...
\end{align*}
\MW{I think this is buggy now (need to use $\Theta$ version of A.1). Also worry about $q\geq1$ (integer is not important I think).}
