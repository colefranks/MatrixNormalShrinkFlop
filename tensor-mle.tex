...
Now we choose $q = c (\sqrt{m} + \sqrt{n})^{2}$ for small enough $c$ such that $C \sqrt{q} \leq \E \|A\|_{\op}$ (by \cref{eq:op norm bound}). \AR{Changed the choice of constant, hope you don't mind}
