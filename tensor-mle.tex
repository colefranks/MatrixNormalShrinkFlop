...
\RMO{In terms of our usual ball the above result will be $B_{k \cdot c}(I)$, right? And if this calculation is correct, can we put the observation that this ball is good? Just to make the statements of our lemmas more uniform.}
