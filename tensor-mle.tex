...
$$\|\Phi\|_0 \leq \frac{\lambda}{\sqrt{d_1d_2}} \tr \Phi(I_{d_2}).$$
\end{enumerate}
A $(0, \lambda)$-quantum expander is called a $(1-\lambda)$-quantum expander.
\end{definition}
...
\begin{lemma}\label{lem:block-matrix-old}
