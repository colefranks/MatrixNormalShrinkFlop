...
\item I'm going to call $\GL = \oplus \GL_{d_i}, \PD = \oplus \PD_{d_i}^1, \Sym = \oplus \Sym_{d_i}^0$. Explain somewhere how $\Sym$ is the tangent space of $\PD$.
...
The result is essentially Theorem~16.6 in~\cite{pisier2012grothendieck} for real Gaussians, together with a standard symmetrization trick (e.g., Proof of Lemma~4.1 in~\cite{P14}).
To be self-contained we give a succinct proof.
