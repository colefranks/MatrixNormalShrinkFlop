...
$\norm{\sqrt{d_{a}} \nabla_a f_x(I_D)}_{\op} \leq c$ for every $a\in[k]$ and $|\nabla_{0} f_{\samp}(I_{D})| \leq c$ \MW{and probably 0 component $\leq c$?} \AR{Good point, added a condition here and used it in appendix B to derive the conditions I need for robustness proof},
