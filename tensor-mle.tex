...
\end{align*}
By the remarks preceding the lemma, the above condition implies $\Phi_Y$ is $\eps \sqrt{\frac1{nD}}$-doubly balanced.
\end{lemma}
...
\AR{Removed $\Theta$} \MW{I think we currently also seem to use some kind of lower bound to wrap up.}
