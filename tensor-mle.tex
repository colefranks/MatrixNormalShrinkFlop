...
In the flip flop algorithm for the general tensor normal model, we cycle through the $k$~many dimensions, using the $a^\text{th}$ flattening of the samples $x_i$ to update $\overline{\Theta}_a$ in the $a^\text{th}$ step.
